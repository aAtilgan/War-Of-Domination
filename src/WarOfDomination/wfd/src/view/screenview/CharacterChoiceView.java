...
public class CharacterChoiceView extends BasicGameState{
	...
	@Override
	/*
	 * This function catches user character and weapon selections by checking simple coordinate constraints. If user clicks
	 * between these constraints this function does the required action
	 * 
	*/
