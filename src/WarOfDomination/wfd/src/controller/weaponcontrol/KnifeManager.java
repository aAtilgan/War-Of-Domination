...
public class KnifeManager {
	...
	/*
	 * This function creates a knife object to track the projectile. It uses a vector to calculate the 
	...
	/*
	 * This function deletes the knife if it collides with a player or an obstacle on the map.
	 * This function updates a SINGLE knife at a time.
	 */
	public void updateKnife(Knife aKnife, float mapPosX, float mapPosY, TiledMap map) 
	{
		...
		{ 
					...
					layerIndex) == 0) 
			{
				...
				if (Math.hypot(characterX - aKnife.getX(), characterY - aKnife.getY()) < 12) 
				{ 
