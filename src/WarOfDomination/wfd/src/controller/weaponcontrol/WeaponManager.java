...
public class WeaponManager {
	...
	/*
	 * This method calls the corresponding method from one of it's helper managers.
	 * This selection is done after 2 checks. 1- Checks the currently selected
	 * weapon of the shooting players character.(#Parameter int type) 2- Checks the
	 * shooting characters weapon selection from menu.(ArrayList<Integer>
	 * RoundData.weapon_choice_hero) According to which of these checks are passed a
	 * shooting command is called.
	 */
	public void shoot(int x, int y, float sourceX, float sourceY, Moving enemy, Moving shooter, int type)
	...
	/*
	 * This class updates all of the projectile objects on the map by calling their
	 * update methods individually. Knifes and bullets might have different
	...
	/*
	 * Calls the render function of all projectiles in this classes listOfWeapons
	 * ArrayList Takes Graphics g as a parameter to pass it over.
	 */
